    ...
    <section id="learn" className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="mb-16 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
          Guía Definitiva de <span className="text-[#5978F5]">CORS</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="glass-panel p-8 hover:bg-[#101C48]/50 transition-colors group border border-[#2C4399]/30"
          >
            <div className="mb-6 p-4 bg-[#5978F5]/10 rounded-xl w-fit group-hover:scale-110 transition-transform duration-300">
              {React.cloneElement(card.icon, { className: "text-[#5978F5]" })}
            </div>
      ...
      <div className="mt-16 text-center">
        <a 
          ...
          className="inline-flex items-center gap-2 px-6 py-3 bg-[#101C48] hover:bg-[#2C4399] text-[#5978F5] hover:text-white rounded-full transition-all font-medium border border-[#2C4399]"
        >
          <Globe size={18} />
